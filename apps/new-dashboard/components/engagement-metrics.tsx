...
interface EngagementData {
  ...
  topEngagedPages: Array<{ path: string; avgTimeMs: number; avgScrollDepth: number; samples: number }>
}
          ...
          <div>
            ...
            <div className="space-y-1">
              {data.topEngagedPages.slice(0, 5).map((page) => (
                <div key={page.path} className="flex items-center justify-between py-1 border-b border-border/50 last:border-0">
