...
export const mockTopPages: ContentMetric[] = [
  ...
  { path: "/docs/getting-started", views: 8934, uniqueVisitors: 5621, avgDuration: 145, bounceRate: 0.18 },
  { path: "/blog/analytics-guide", views: 6721, uniqueVisitors: 4532, avgDuration: 234, bounceRate: 0.22 },
  { path: "/features", views: 5432, uniqueVisitors: 3876, avgDuration: 56, bounceRate: 0.35 },
  { path: "/docs/api-reference", views: 4123, uniqueVisitors: 2987, avgDuration: 312, bounceRate: 0.12 },
