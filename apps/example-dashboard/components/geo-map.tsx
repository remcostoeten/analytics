...
const countryNameToNumericCode: Record<string, string> = {
  ...
  "Bangladesh": "050", "Belarus": "112", "Belgium": "056", "Bolivia": "068",
  "Bosnia and Herzegovina": "070", "Brazil": "076", "Bulgaria": "100", "Cambodia": "116",
  "Cameroon": "120", "Canada": "124", "Chile": "152", "China": "156",
  ...
  "Kenya": "404", "Kuwait": "414", "Latvia": "428", "Lebanon": "422",
  "Libya": "434", "Lithuania": "440", "Luxembourg": "442", "Malaysia": "458",
  "Mexico": "484", "Moldova": "498", "Mongolia": "496", "Morocco": "504",
  "Myanmar": "104", "Nepal": "524", "Netherlands": "528", "New Zealand": "554",
  "Nigeria": "566", "North Korea": "408", "Norway": "578", "Oman": "512",
  "Pakistan": "586", "Panama": "591", "Paraguay": "600", "Peru": "604",
  "Philippines": "608", "Poland": "616", "Portugal": "620", "Puerto Rico": "630",
  ...
  "Sri Lanka": "144", "Sudan": "736", "Sweden": "752", "Switzerland": "756",
...
const isoCodeToNumericCode: Record<string, string> = {
  "AF": "004", "AL": "008", "DZ": "012", "AR": "032", "AM": "051", "AU": "036",
  "AT": "040", "AZ": "031", "BD": "050", "BY": "112", "BE": "056", "BO": "068",
  "BA": "070", "BR": "076", "BG": "100", "KH": "116", "CM": "120", "CA": "124",
  "CL": "152", "CN": "156", "CO": "170", "CR": "188", "HR": "191", "CU": "192",
  "CY": "196", "CZ": "203", "DK": "208", "DO": "214", "EC": "218", "EG": "818",
  "SV": "222", "EE": "233", "ET": "231", "FI": "246", "FR": "250", "GE": "268",
  "DE": "276", "GH": "288", "GR": "300", "GT": "320", "HN": "340", "HK": "344",
  "HU": "348", "IS": "352", "IN": "356", "ID": "360", "IR": "364", "IQ": "368",
  "IE": "372", "IL": "376", "IT": "380", "JM": "388", "JP": "392", "JO": "400",
  "KZ": "398", "KE": "404", "KW": "414", "LV": "428", "LB": "422", "LY": "434",
  "LT": "440", "LU": "442", "MY": "458", "MX": "484", "MD": "498", "MN": "496",
  "MA": "504", "MM": "104", "NP": "524", "NL": "528", "NZ": "554", "NG": "566",
  "KP": "408", "NO": "578", "OM": "512", "PK": "586", "PA": "591", "PY": "600",
  "PE": "604", "PH": "608", "PL": "616", "PT": "620", "PR": "630", "QA": "634",
  "RO": "642", "RU": "643", "SA": "682", "SN": "686", "RS": "688", "SG": "702",
  "SK": "703", "SI": "705", "ZA": "710", "KR": "410", "ES": "724", "LK": "144",
  "SD": "736", "SE": "752", "CH": "756", "SY": "760", "TW": "158", "TZ": "834",
  "TH": "764", "TN": "788", "TR": "792", "UA": "804", "AE": "784", "GB": "826",
  "US": "840", "UY": "858", "UZ": "860", "VE": "862", "VN": "704", "YE": "887",
  "ZW": "716",
}
                ...
                return (
                  <Geography
                    ...
                    style={{
                      ...
                      hover: { 
                        fill: hasData ? "hsl(var(--primary))" : "hsl(var(--muted-foreground) / 0.2)",
                        outline: "none",
                        cursor: hasData ? "pointer" : "default",
                      },
            ...
            <div className="flex items-center gap-2">
              ...
              <div>
                ...
                <p className="text-[10px] text-muted-foreground">
                  {tooltipContent.count.toLocaleString()} visits ({tooltipContent.percentage.toFixed(1)}%)
                </p>
              </div>
            </div>
          </div>
      ...
      <div className="px-3 py-2 border-t border-border">
        <div className="flex items-center gap-3 mb-2">
          ...
          <div className="flex items-center gap-1">
            <div 
              ...
              style={{ background: "linear-gradient(to right, hsl(var(--primary) / 0.2), hsl(var(--primary)))" }} 
            />
        ...
        <div className="flex flex-wrap gap-2">
          {data.slice(0, 6).map((d) => (
            ...
            >
              {d.countryCode && (
                <span className="text-[10px]">{getFlagEmoji(d.countryCode)}</span>
              )}
