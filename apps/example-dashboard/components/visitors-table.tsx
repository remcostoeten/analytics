                ...
                <td className="px-3 py-1.5">
                  <div className="flex items-center gap-1.5">
                    <span className={cn(
                      ...
                      visitor.deviceType === 'desktop' && "bg-blue-500/15 text-blue-600 dark:text-blue-400",
                      visitor.deviceType === 'mobile' && "bg-green-500/15 text-green-600 dark:text-green-400",
                      visitor.deviceType === 'tablet' && "bg-purple-500/15 text-purple-600 dark:text-purple-400",
                      (!visitor.deviceType || visitor.deviceType === 'unknown') && "bg-muted text-muted-foreground"
                    )}>
        ...
        <div className="border-t border-border p-3 bg-muted/30">
          ...
          <div className="grid grid-cols-2 gap-x-4 gap-y-1.5 text-[10px]">
            ...
            <div className="flex items-center gap-1.5">
              ...
              <span className="text-foreground">{selectedVisitor.screenResolution || 'Unknown'}</span>
            </div>
            <div className="flex items-center gap-1.5">
