					...
					return (
						<div key={index} className="relative group">
							...
							<div className="relative flex items-center gap-2.5 px-3 py-2.5">
								{/* Rank */}
								<span className="text-[10px] font-medium text-muted-foreground/50 tabular-nums w-4 shrink-0 text-right">
									{index + 1}
								</span>
								...
								<div className="flex-1 min-w-0">
									{isSinglePage ? (
										...
										<div className="flex items-center gap-1 flex-wrap">
											...
											{isRoundTrip && (
												<span className="text-[10px] text-muted-foreground/50 italic ml-0.5">
													roundtrip
												</span>
											)}
										</div>
