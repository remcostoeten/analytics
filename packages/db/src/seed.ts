			...
			for (let p = 0; p < pageviewCount; p++) {
				...
				if (isFunnelSession && funnelStep === 1) {
					entries.push({
						projectId,
						type: "event",
						ts: new Date(timestamp.getTime() + 2000),
						path,
						visitorId,
						sessionId,
						deviceType,
				...
				if (isFunnelSession && funnelStep === 2) {
					entries.push({
						projectId,
						type: "event",
						ts: new Date(timestamp.getTime() + 3000),
						path,
						visitorId,
						sessionId,
						deviceType,
				...
				if (Math.random() > 0.8) {
					entries.push({
						projectId,
						type: "event",
						ts: new Date(timestamp.getTime() + 5000),
						path,
						visitorId,
						sessionId,
						deviceType,
				...
				if (Math.random() > 0.3) {
					entries.push({
						projectId,
						type: "event",
						ts: new Date(timestamp.getTime() + 100),
						path,
						visitorId,
						sessionId,
						deviceType,
				...
				if (Math.random() > 0.5) {
					entries.push({
						projectId,
						type: "event",
						ts: new Date(timestamp.getTime() + 15000),
						path,
						visitorId,
						sessionId,
						deviceType,
